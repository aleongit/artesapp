    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Eliminar Client 
            <strong>{{ client.nom }}</strong></h5>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-footer">
          ...
          <button type="butoon" class="btn btn-primary" @click="delClient(client.id)">
...
export default {
  ...
  methods: {
    ...
    //funció assíncrona
    delClient: async function (id) {
      console.log(id);

      //prova response
      try {
        const response = await clientService.eliminar(id);
